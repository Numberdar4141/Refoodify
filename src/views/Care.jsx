...
import imageFour from "../assets/ngo1.png";
import FadeIn from "../components/FadeIn";

const Care = () => {
  return (
    <div id="care" className="px-10 mt-[120px] max-w-[1490px] mx-auto ">
      ...
      <div>
        <button className="bg-orange-400 rounded-2xl ml-[600px] mt-[40px]  animate-bounce text-white text-[22px] h-[40px] w-[120px]">Join Now</button>
      </div>
