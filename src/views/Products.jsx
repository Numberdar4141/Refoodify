      ...
      <div className="w-full flex flex-col md:flex-row gap-[160px] md:gap-6">
        {products.map((product, i) => (
          <FadeIn key={i} delay={(i + 1) * 0.2} direction="left" fullWidth>
            ...
            <div className="h-[510px] relative flex-1 bg-white  before:content-['']  before:absolute before:block before:w-full before:h-[480px] before:bottom-[50px] before:left-0 before:bg-orange-400 before:rounded-[50px] before:hover:scale-y-100 before:scale-y-0 before:origin-bottom-left before:transition before:ease-in-out before:duration-1000   border-2 rounded-[50px] max-w-[500px]">
              <img
                src={product.img}
                alt=""
                className="absolute -top-[120px] rounded-full left-1/2 -translate-x-1/2"
              />
              <div className="absolute bottom-0 w-full bg-orange-400 h-[260px]  rounded-[50px] shadow-md px-8 py-[26px] flex flex-col justify-between">
                <div>
